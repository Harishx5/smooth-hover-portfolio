...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="min-h-screen w-full flex flex-col items-center justify-center relative px-4 py-16 md:py-0">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-fade-in-up opacity-0" style={{ animationDelay: "0.2s" }}>
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold mb-6 gradient-text">
          Our Team Portfolio
        </h1>
        <p className="text-lg sm:text-xl mb-8 md:mb-12 mx-auto text-gray-300">
